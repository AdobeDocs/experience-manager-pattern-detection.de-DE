...
* `missing.original.rendition`: Identifizieren Sie die Assets mit fehlender obligatorischer Original-Ausgabedarstellung im Repository. Beachten Sie bitte, dass für die Vorschau von PDF-Seiten keine Erstellung von Unter-Assets in AEMaaCS erforderlich ist. Daher wird bei PDF-Assets die Berichterstellung für Teil-Assets, denen die ursprüngliche Ausgabedarstellung fehlt, unterdrückt.
...
* AEM Assets benötigt die vorhandene Original-Ausgabedarstellung. Die Asset-Verarbeitung in Cloud Service bleibt in einer Schleife hängen, wenn die Original-Ausgabedarstellung fehlt. Die Erstellung von Unter-Assets wird in AEMaaCS nicht unterstützt.
...
* Keine Aktion erforderlich für fehlende Original-Ausgabeformate von Teil-Assets.
