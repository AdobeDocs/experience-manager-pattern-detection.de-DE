...
* Die **[!UICONTROL Email PDF]** Sendeaktion ist nicht verfügbar.  (EMAIL_PDF_SUBMIT_ACTION)
...
* Wenden Sie sich an das Supportteam, damit Sie die E-Mail-Funktion für Ihre Umgebung aktivieren können (SMTP-Port öffnen). Standardmäßig sind nur ausgehende HTTP- und HTTPS-Verbindungen aktiviert. (EMAIL_SERVICE_CONFIGURATION, E-Mail-Schritt)
...
* Entfernen Sie den Überprüfungsschritt aus Ihrem vorhandenen adaptiven Forms, bevor Sie diese Formulare in ein [!DNL Cloud Service] Umgebung. (VERIFY_STEP)
...
Kontakt [Adobe-Unterstützung](https://helpx.adobe.com/de/enterprise/using/support-for-experience-cloud.html) wenn Sie Klarstellungen oder angesprochene Bedenken benötigen.
