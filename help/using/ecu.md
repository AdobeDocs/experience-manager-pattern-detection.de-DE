...
So können Kunden leichter nachvollziehen, welche Bereiche von `/libs` sind sicher zu verwenden und zu überlagern, der Inhalt in `/libs` wurde mit &quot;Mixin&quot;-Eigenschaften klassifiziert:
